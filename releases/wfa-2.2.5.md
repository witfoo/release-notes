# WitFoo Agent (WFA) v2.2.5

**Released:** 2026-06-19 04:27:27 UTC

## Changes

fb12a795 chore(release): WFA 2.2.5 — CWE-295 readiness-probe TLS fix (PR391) + common v1.5.39
9ff12248 fix(cli): verify TLS peer in checkHTTPReadiness (CWE-295, PR391a)
cb80ea0e chore(deps): bump common → v1.5.39 (PR392b fleet pin sync)
6746f644 chore(release): WFA 2.2.4 — console-client self-registration (#160)
a65ae5b3 feat(console-client): self-register node with Console before WebSocket auth (#160)
